...
<div class="container" style="margin-top: 50px; width: 500px">
  <form method="POST" action="cliente-controller">
    <div class="mb-3">
  ...
  <table class="table">
    ...
    <c:forEach var="c" items="${Clientes}">
      <tr style="text-align: center">
        <td>${c.nome}</td>
        <td>${c.cpf}</td>
        <td><a href="http://localhost:8080/lojaSuplementos/cliente-controller?opcao=editar&&id=${c.id}">Editar</a></td>
        <td><a href="http://localhost:8080/lojaSuplementos/cliente-controller?opcao=excluir&&id=${c.id}">Excluir</a></td>
      </tr>
    </c:forEach>
    </tbody>
  </table>
